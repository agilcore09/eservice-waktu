...
<div class="card-body">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <label>Alamat</label>
                <input type="text" class="form-control" name="alamat" class="form-control" autocomplete="off" value=""" required />
            </div>
        </div>
            ...
            <div class="col-sm-3">
                <label>Estimasi Selesai</label>
                  <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                      <input type="text" class="form-control datetimepicker-input" name="estimasi" data-target="#reservationdatetime"/>
